...
app.config['CSRF_ENABLED'] = False #Cross Site Request Forgery - our forms are good....no security needed...Turnign it on causes error because there's not a module.
...
k = Key(rs[1])
k.key = "static/images/puggrass.svg"
k.set_contents_from_filename("static/images/puggrass.svg")
# k.set_contents_from_string('This is a test of S3')
k.get_contents_to_filename("static/images/earphones.svg")
